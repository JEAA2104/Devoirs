...
\subsection{Meilleure planification}
Selon moi, la meilleure planification de projet lors du cours de BSQ201 a été la planification traditionnelle. Dans notre cas, nous n'avions pas beaucoup de temps alloué pour essayer d'autre façon de planifier car notre session était extrêmement chargée. Cependant, nous avons fait une bonne utilisation de ce type de planification en divisant le projet en plusieurs phases que nous nous sommes plus ou moins attribuées mon équipe et moi. Grâce à cette planification, nous avons pu bien gérer notre temps et respecter les échéances malgré la charge de travail importante.
\subsection{Difficultés organisationnelles}
Pour le projet, le plus diffcile pour nous aurait été la difficulté de coordination entre les membres de l'équipe pusique plusieurs d'entre-noua vait des horaires différents des autres. Cependant, nous avons su régler le problème dès le début avec une bonne communication via messenger et en nous assurant de bien nous organiser pour les réunions d'équipe.
\subsection{Améliorations de la planification}
En vérité, la difficulté principale que j'ai trouvé n'était pas la gestion de projet en soi, mais plutôt la charge de travail globale de la session qui était très élevée. Il y a deux possibles suggestions, soi les projets sont un tout petit peu moins demandants avec une meilleure répartion des tâches, soi la gestion de projet est bâtie à travers plusieurs sessions pour éviter de surchager les étudiants (je sais que c'est hors de notre contrôle, mais c'est vraiment ce que j'ai ressenti).
\subsection{Gestion des conflits}
Il n'y a eu aucun conflit majeur dans notre équipe tout simplement parce que nous nous conaissons depuis déjà un an et que nous conaissons chacun nos forces et faiblesses. Cependant, si jamais un conflit devait survenir, je pense que la meilleure façon de le gérer serait d'en parler ouvertement en équipe pour trouver une solution ensemble.
\subsection{Amélioration du cours}
Je vais répéter les mêmes points que les autres étudiants ont dit, mais je vais faire simple et efficace. En premier lieu, le cours donne beaucoup de bons outils et les bons concepts pour faire une gestion efficace de projet. Le projet de cette session était en lien avec le baccalauréat, ce qui est une très belle touche pour notre programme tant oublié (parfois). Une ambiance amicale et plus personnelle rend le cours vraiment moins froid et vraiment plus agréable, surtout comparé à d'autres cours données par d'autre département qui ne le sont pas vraiment. Par contre, les cours était un peu trop théoriques et peu interactifs. J'aurais aimé plus d'activités de groupe ou des études de cas pour mieux comprendre les concepts et pour mieux voir en pratique de quoi ça a l'air (un changement de nos cours magistraux quoi). Finalement, le projet était un peu trop vague et trop étrange dans ses consignes pour vraiment atteindre son plein potentiel. Je crois cependant, qu'avec le temps et l'expérience, le cours pourrait être vraiment intéressant et très utile pour les étudiants du BSIQ :).
\end{document}